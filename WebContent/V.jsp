		...
		<div class="row">
			<div class="col-md-6 col-md-offset-3">
				<div class="register-box">
					...
					<h1 class="text-center">VT_AND_VN-SHOW</h1>
					</div>
					<form action="" method="">
					<div class="form-group" id="d0">
							...
							String url = "/Users/jiaojiao/eclipse-workspace/Parsing/WebContent/outfile/v_out"; // LL(1)分析输出
